...
> **Warning:** This is a personal tool, not a production service. It takes shortcuts (direct filesystem project management, no auth). Do not expose it to the public internet. Use for your pesonal amusement only.
